...
import com.example.jobgeniet1.databinding.CompanyViewBinding;

import java.util.ArrayList;

public class CompanyView extends Fragment {

    private CompanyViewBinding binding;
    ...
    public View onCreateView(
        ...
        binding = CompanyViewBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(CompanyView.this)
                        .navigate(R.id.action_companyView_to_companyAppContact);
            }
        });
    }
